...
IoT-enabled solar monitoring system developed for Smart India Hackathon, featuring voltage/current monitoring, ESP8266 connectivity, ThingSpeak cloud visualization, and waterless solar-panel cleaning.
